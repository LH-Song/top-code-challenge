...
const ShareResult = ({
  ...
  return (
    <div className="w-full gap-4 space-y-4 p-4 lg:flex lg:flex-row lg:justify-between lg:gap-0 lg:space-y-0">
      ...
      >
        <div className="flex w-[50vw] items-center justify-start gap-4 rounded-md bg-white px-4 py-2 text-black hover:bg-black hover:text-white lg:w-auto lg:justify-end">
